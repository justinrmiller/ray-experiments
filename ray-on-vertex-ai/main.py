...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--cuda", help="Enables GPU training"
    )
    parser.add_argument(
    ...
    print(f"""
        Starting job on address: {address}
        With runtime environment: {runtime_env}
    ...
    print(f"Starting process with address={address}, num_samples={num_samples}, num_iteration={num_iterations} ")
    ...
    print(f"Best config is {results.get_best_result().config}")
